...
python -m ipykernel install --user --name={{repo_name}} --display-name "{{Repo Name}}" # install globally outside of poetry

echo "Jupyter kernel '{{repo_name}}' has been installed."
